        ...
        <section class="resource-list">
          ...
          <div class="active-filters" v-if="query.categoryId || query.tagIds.length || query.keyword || query.sortBy">
            ...
            <n-tag
              ...
              :bordered="false"
              :color="{ color: '#efece2', textColor: '#5d6a66' }"
            >
              关键词：{{ query.keyword }}
            </n-tag>
            <n-tag
              ...
              :bordered="false"
              :color="{ color: '#e6f1ed', textColor: '#0f6d70' }"
            >
            ...
            <n-tag
              ...
              @close="removeTag(tid)"
              :bordered="false"
              :color="{ color: '#f5e4c5', textColor: '#8a571b' }"
            >
              {{ getTagName(tid) }}
            </n-tag>
            <n-tag
              ...
              :bordered="false"
              :color="{ color: '#e9f0eb', textColor: '#416260' }"
            >
          ...
          <!-- Empty -->
          <EmptyState v-else-if="!resources.length" text="暂无匹配的资源" />
